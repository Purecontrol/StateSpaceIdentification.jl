...
mutable struct GaussianNonParametricStateSpaceSystem <: AbstractStateSpaceSystem
    ...
    function GaussianNonParametricStateSpaceSystem(
            M_t,
            H_t,
            R_t,
            Q_t,
...
"""
function default_filter(model::ForecastingModel{Z, GaussianNonParametricStateSpaceSystem, S};
...
"""
function default_smoother(model::ForecastingModel{Z, GaussianNonParametricStateSpaceSystem, S};
        kwargs...) where {Z <: Real, S <: AbstractState{Z}}
